...
const DoctorLoginForm = () => {
  const initialValues = { FullName: "",Name: "", Password: ""};
  ...
  const handleLogin = () => {
      ...
      const data = {
          ...
          doctorId: formValues.Name,
          password: formValues.Password,

      };
      const url = 'https://localhost:7081/api/Provider/DoctorLogin';
      ...
      <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
          ...
          <nav id="navbar" class="navbar order-last order-lg-0">
            ...
            <li><Link class="nav-link scrollto" to="/Login">Back</Link></li>
            </ul>
            ...
            <center>
              <div>
                ...
                <input
                  ...
                  <div className="text-center"><button className={styles.formSubmitBtn} id="contact_button" onClick={handleLogin}
