...
function PatientPortal() {
    ...
    const initialValues = { PatientId: ""};
    const [formValues, setFormValues] = useState(initialValues);
        const getcategory = async (PatientId) =>{
            alert(PatientId);
            const res= await fetch('https://localhost:7081/api/Patient/patientaccount?PatientId='+PatientId+'');
  ...
  return (
    ...
    <div class="container d-flex justify-content-between">
      ...
      <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
          ...
          <ul>
          <li><Link class="nav-link scrollto" to="/Login" onClick={Logout}>Logout</Link></li>
          </ul>
    ...
    <div class="container">
        ...
        <div class="container">
          ...
          <div>
          <Link to = "/PatientAccount" class="appointment-btn scrollto"> My Account</Link><br/><br/>
          <Link to = "/Appointment" class="appointment-btn scrollto"> Make an Appoinment</Link><br/><br/>
          <Link to = "/ViewStatus" class="appointment-btn scrollto">View Appointment Status</Link><br/><br/>
      </div>
    </div>
    </section>
    </div>
