...
function DoctorAccount() {
    ...
    const getcategory = async (Name) =>{
        const res= await fetch('https://localhost:7081/api/Provider/ViewDoctor?DoctorId='+Name+'');
...
<center><Link to="/ModifyPageDoctor"><button class="btn btn-success" >Modify</button></Link></center>
