  ...
  return (
      ...
      <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
          ...
          <nav id="navbar" class="navbar order-last order-lg-0">
            <ul>
            <li><Link class="nav-link scrollto" to="/Login">Logout</Link></li>
            </ul>
    ...
    <div class="container">
        ...
        <div class="container">
          ...
          <div class="container">
          <Link to = "/AddAdmin" class="appointment-btn scrollto"> Add Admin</Link><br/><br/>
          <Link to = "/AllPatients" class="appointment-btn scrollto"> All Patients</Link><br/><br/>
          <Link to = "/AllDoctors" class="appointment-btn scrollto"> All Doctors</Link><br/><br/>
          <Link to = "/ViewAppointments" class="appointment-btn scrollto"> All Appointments</Link><br/><br/>
      </div>
    </div>
    </section>
    </div>
