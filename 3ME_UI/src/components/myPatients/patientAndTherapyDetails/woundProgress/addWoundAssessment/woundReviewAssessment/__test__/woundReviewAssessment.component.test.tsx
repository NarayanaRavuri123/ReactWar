...
describe("MWP Wound assessment form review page ->", () => {
  afterAll(() => {
    cleanup();
  });
  it("MWP Wound assessment form review page wound therapy status", () => {
  ...
  it("MWP Wound assessment form review page wound measurement status", () => {
    const defaultValues: IAddWoundAssessment = getDeepClone(
      defaultAddWoundAssessment
    );
  ...
  it("MWP Wound assessment form review page wound Eschar status", () => {
    const defaultValues: IAddWoundAssessment = getDeepClone(
      defaultAddWoundAssessment
    );
    defaultValues.woundTherapyStatus.value = "yes";
  ...
  it("MWP Wound assessment form review page wound holds and hospitalization status", () => {
    const defaultValues: IAddWoundAssessment = getDeepClone(
      defaultAddWoundAssessment
    );
    defaultValues.woundTherapyStatus.value = "yes";
  ...
  it("MWP Wound assessment form review page wound infection status", () => {
    const defaultValues: IAddWoundAssessment = getDeepClone(
      defaultAddWoundAssessment
    );
    defaultValues.woundTherapyStatus.value = "yes";
  ...
  it("MWP Wound assessment form review page wound Assessor status", () => {
    const defaultValues: IAddWoundAssessment = getDeepClone(
      defaultAddWoundAssessment
    );
    defaultValues.woundTherapyStatus.value = "yes";
